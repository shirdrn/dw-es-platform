...
public abstract class RetryIndexingClient<RECORD, CONTENT, CLIENT, T> extends AbstractIndexingClient<RECORD, CONTENT> {
	...
	public RetryIndexingClient(IndexRequestCreator<RECORD, CONTENT> indexRequestCreator) {
