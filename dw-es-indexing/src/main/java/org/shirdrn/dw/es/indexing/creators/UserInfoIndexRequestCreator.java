package org.shirdrn.dw.es.indexing.creators;
...
public class UserInfoIndexRequestCreator extends AbstractIndexRequestCreator {

	private static final Log LOG = LogFactory.getLog(UserInfoIndexRequestCreator.class);
	private Iterator<IndexRequest> iterator;
	private final ContentBuilder<String> contentBuilder;
	
	public UserInfoIndexRequestCreator(String index, String type, String inputFile) {
		super(index, type);
		this.contentBuilder = new UserInfoContentBuilder();
		indexingDataSource = new FileIndexingDataSource(this, contentBuilder, inputFile);
	}
	...
	private final class UserInfoContentBuilder implements ContentBuilder<String> {

		@Override
		public DocContent build(String record) {
			DocContent content = null;
			try {
